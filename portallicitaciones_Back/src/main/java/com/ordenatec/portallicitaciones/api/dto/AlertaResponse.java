...
public class AlertaResponse {
    ...
    private String horaEnvio;       // devolvemos como "10:00"
    ...
    public String getTiposContratos() {
        return tiposContratos;
    }

    public void setTiposContratos(String tiposContratos) {
        this.tiposContratos = tiposContratos;
    }

    public Boolean getContratosMenores() {
        return contratosMenores;
    }

    public void setContratosMenores(Boolean contratosMenores) {
        this.contratosMenores = contratosMenores;
    }
    ...
    public String getOrganosContratacion() {
        return organosContratacion;
    }

    public void setOrganosContratacion(String organosContratacion) {
        this.organosContratacion = organosContratacion;
    }
    ...
    public Boolean getNotificarCambios() {
        return notificarCambios;
    }

    public void setNotificarCambios(Boolean notificarCambios) {
        this.notificarCambios = notificarCambios;
    }
